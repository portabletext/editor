...
| [`@portabletext/sanity-bridge`](https://github.com/portabletext/editor/tree/main/packages/sanity-bridge)           | Convert between Sanity schemas and Portable Text schemas       | `npm i @portabletext/sanity-bridge`      |
...
| [`@portabletext/plugin-dnd`](https://github.com/portabletext/editor/tree/main/packages/plugin-dnd)                                           | Track drop position for custom drop indicators       | `npm i @portabletext/plugin-dnd`                      |
...
| [`@portabletext/plugin-list-index`](https://github.com/portabletext/editor/tree/main/packages/plugin-list-index)                             | Compute list indices for custom list rendering       | `npm i @portabletext/plugin-list-index`               |
...
| [`@portabletext/plugin-table`](https://github.com/portabletext/editor/tree/main/packages/plugin-table)                                       | Table editing with spreadsheet-grade selection       | `npm i @portabletext/plugin-table`                    |
