...
This guide walks you through installing and configuring the Portable Text Editor. By the end, you'll have a working rich text editor with custom styles, decorators, and a toolbar.
