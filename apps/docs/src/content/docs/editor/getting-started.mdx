...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Keep reading to create a customizable editing experience"
    href="#add-the-library-to-your-project"
  />
</CardGrid>
...
This guide walks you through installing and configuring the Portable Text Editor (PTE). By the end, you'll have a working rich text editor with custom styles, decorators, and a toolbar.
