...
:::note
This guide includes a limited set of schema types to get you started. See the [rendering guide](/editor/guides/custom-rendering/) for additional style and mark examples, and the [custom blocks guide](/editor/guides/custom-blocks/) for block and inline objects.
:::
...
const schemaDefinition = defineSchema({
  ...
  lists: [],
  // Left empty here; enabling lists also needs a registered list-item render.
  // Ordered-list numbering isn't computed by the engine, it comes from
