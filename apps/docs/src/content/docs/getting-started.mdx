...
description: Choose your path — render Portable Text content or build a rich text editor.
next: false
prev: false
---
...
:::note
This guide includes a limited set of schema types, or rich text elements, to get you started. See the [rendering guide](/editor/guides/custom-rendering/) for additional examples.
:::
...
Learn more about the [Behaviors](/editor/concepts/behavior/) and how to [create your own behaviors](/editor/guides/create-behavior/) in the documentation.
