...
The PTE is a fully customizable rich text editor that uses the Portable Text format.
This guide leads you through installing and using the basic features of the Portable Text Editor (PTE).

In order to set up a PTE implementation, you must:
...
<LinkCard title="Further customize the toolbar" description="Dive deeper into toolbar customization." href="/guides/customize-toolbar/" />
