...
2. Create a `ToolbarPlugin` component, along with any sub-components in the same file.
...
6. Add the `ToolbarPlugin` to the your render function inside the `EditorProvider`.
