...
### [Behavior API](/reference/behavior-api/)
...
Pure functions for deriving state from the editor snapshot — block selectors, span selectors, selection state, active marks, and text position utilities.
