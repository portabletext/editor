...
description: Why structured block content beats HTML strings and Markdown for content that needs to work across platforms.
---
...
- **No data-carrying annotations.** A Markdown link is `[text](url)`. If you need a link with a target, a tooltip, tracking parameters, and an internal reference ID, you're back to embedding HTML.
