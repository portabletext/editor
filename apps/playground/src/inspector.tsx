...
const LAYER_KINDS: ReadonlyArray<DecorationLayerKind> = ['comments', 'presence']
...
/** Separate component so the dynamic editor/layer map gives each entry its own `useDecorations` call. */
function LayerPositions(props: {
  kind: DecorationLayerKind
  layer: DecorationLayer
}) {
  const positions = useDecorations(props.layer)
