...
- [#3246](https://github.com/portabletext/editor/pull/3246) [`e52a9d2`](https://github.com/portabletext/editor/commit/e52a9d24b73c71dee09ad7b039dc3de9dd62db50) Thanks [@christianhg](https://github.com/christianhg)! - fix: emit structural repair patches immediately and make engine normalization the sole repairer
...
- [#3301](https://github.com/portabletext/editor/pull/3301) [`8abd6b4`](https://github.com/portabletext/editor/commit/8abd6b4a378563166eeaeffc57d079967ec3fbbd) Thanks [@christianhg](https://github.com/christianhg)! - feat: add `editor.registerDecorations`, a registration channel for decoration layers
...
- [#3271](https://github.com/portabletext/editor/pull/3271) [`c53b2db`](https://github.com/portabletext/editor/commit/c53b2dbcbd208367721290652a21c6e04062933b) Thanks [@christianhg](https://github.com/christianhg)! - fix: restore `data-slate-editor` on the editable element so Grammarly recognizes it
...
- [#3216](https://github.com/portabletext/editor/pull/3216) [`bfda552`](https://github.com/portabletext/editor/commit/bfda552c3519ce492a2fe4f416d4226295581900) Thanks [@christianhg](https://github.com/christianhg)! - fix: guard `drag` and `dragleave` handlers without resolving an event position
...
- [#3046](https://github.com/portabletext/editor/pull/3046) [`b18469f`](https://github.com/portabletext/editor/commit/b18469f7c73ef036c633142f3864ed16a70fa93c) Thanks [@christianhg](https://github.com/christianhg)! - fix: treat `undefined` and `[]` as equal empty values in value sync
...
- [#2974](https://github.com/portabletext/editor/pull/2974) [`32c622e`](https://github.com/portabletext/editor/commit/32c622eb6c377a28646195ada69e8a47d30bb690) Thanks [@ryanbonial](https://github.com/ryanbonial)! - fix: apply remote patches addressing `marks` and `markDefs` elements as data patches
...
- [#2804](https://github.com/portabletext/editor/pull/2804) [`0768dc5`](https://github.com/portabletext/editor/commit/0768dc5ecff4a5ee90b58242f35a54ac3f6cfbb0) Thanks [@christianhg](https://github.com/christianhg)! - feat: export `getContainerChildren` from `@portabletext/editor/traversal`
...
- [#2806](https://github.com/portabletext/editor/pull/2806) [`737d618`](https://github.com/portabletext/editor/commit/737d618ac78a3ae133701862861f03b9c39a3656) Thanks [@christianhg](https://github.com/christianhg)! - fix(perf): resolve `getChildren` segments via `blockIndexMap`
...
- [#2772](https://github.com/portabletext/editor/pull/2772) [`8ed6233`](https://github.com/portabletext/editor/commit/8ed623380c516add8851fedec26eba62edd13198) Thanks [@christianhg](https://github.com/christianhg)! - feat: subscribe to low-level editor operations via `editor.on('operation', ...)`
...
- [#2757](https://github.com/portabletext/editor/pull/2757) [`c92beef`](https://github.com/portabletext/editor/commit/c92beefeb17631046ea1b5e04c3aa9c4274f520e) Thanks [@christianhg](https://github.com/christianhg)! - fix: apply `insertReplacementText` at the correct position inside iframes
...
- [#2703](https://github.com/portabletext/editor/pull/2703) [`eb0b234`](https://github.com/portabletext/editor/commit/eb0b234ac1c16ebf89ae0253d02d0845f3d9224d) Thanks [@christianhg](https://github.com/christianhg)! - fix: emit `'selection'` only when the selection actually moves
...
- [#2430](https://github.com/portabletext/editor/pull/2430) [`f1a6fb4`](https://github.com/portabletext/editor/commit/f1a6fb46291d862f385ebb0ecdacc712feed8d52) Thanks [@christianhg](https://github.com/christianhg)! - fix: allow `set` patch to replace entire editor value
...
- [#2429](https://github.com/portabletext/editor/pull/2429) [`4247d17`](https://github.com/portabletext/editor/commit/4247d174801ffac782906a4569de3536dd7e2079) Thanks [@christianhg](https://github.com/christianhg)! - fix(perf): reduce unnecessary memory allocations in editor hot path
