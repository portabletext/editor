...
const coreBehaviors = [
  ...
  ...coreDndBehaviors,
  coreBlockObjectBehaviors.arrowRightIntoBlockObject,
  coreBlockObjectBehaviors.arrowLeftIntoBlockObject,
  coreBlockObjectBehaviors.arrowRightFromBlockObject,
  coreBlockObjectBehaviors.arrowLeftFromBlockObject,
  coreBlockObjectBehaviors.deleteForwardIntoBlockObject,
  coreBlockObjectBehaviors.deleteBackwardIntoBlockObject,
  coreBlockObjectBehaviors.deleteSelectedBlockObject,
  coreBlockObjectBehaviors.backspaceSelectedBlockObject,
