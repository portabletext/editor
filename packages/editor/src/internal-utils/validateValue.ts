            ...
            textBlock.children.some((child, cIndex: number) => {
              ...
              if (!child._type) {
                resolution = {
                  ...
                  description: `Child ${describeChildLocation(child, cIndex)} in block ${describeEnclosingBlockLocation(blk, index)} is missing '_type' property.`,
              ...
              if (!validChildTypes.includes(child._type)) {
                resolution = {
                  ...
                  description: `Child ${describeChildLocation(child, cIndex)} in block ${describeEnclosingBlockLocation(blk, index)} has invalid '_type' property (${child._type}).`,
                  action: 'Remove the object',
                  item: blk,
              ...
              if (
                ...
                resolution = {
                  ...
                  description: `Child ${describeChildLocation(child, cIndex)} in block ${describeEnclosingBlockLocation(blk, index)} has missing or invalid text property!`,
