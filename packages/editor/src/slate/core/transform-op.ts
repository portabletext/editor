...
/**
 * Apply an operation to the editor's children and selection.
 *
 * This is the low-level operation engine that mutates `editor.children` and
 * `editor.selection` based on the operation type.
 */
export function transformOp(editor: Editor, op: Operation): void {
