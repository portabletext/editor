...
export const DOMEditor: DOMEditorInterface = {
  ...
  toDOMPoint: (editor, point) => {
    ...
    const selector = `[data-slate-string], [data-pt-string], [data-slate-zero-width], [data-pt-zero-width]`
    ...
    if (parentNode) {
      ...
      const nonEditableNode =
        ...
        containsShadowAware(editorEl, potentialNonEditableNode)
          ...
          : null
      let leafNode =
        parentNode.closest('[data-slate-leaf]') ??
        parentNode.closest('[data-pt-leaf]')
      ...
      if (leafNode) {
        ...
        const leafNodes = voidNode.querySelectorAll(
          '[data-slate-leaf], [data-pt-leaf]',
        )
        ...
        if (!leafNode) {
          ...
          domNode
            .querySelectorAll('[data-slate-zero-width], [data-pt-zero-width]')
            .forEach((el) => {
        ...
        const getLeafNodes = (node: DOMElement | null | undefined) =>
          node
            ? node.querySelectorAll(
                ...
                '[data-slate-leaf]:not(:scope [data-slate-editor] [data-slate-leaf]), [data-pt-leaf]:not(:scope [data-slate-editor] [data-pt-leaf])',
              )
            : []
    ...
    if (IS_ANDROID && !textNode && !exactMatch) {
      ...
      if (node && DOMEditor.hasDOMNode(editor, node, {editable: true})) {
        ...
        if (
          ...
          !node.querySelector('[data-pt-leaf]')
        ) {
