...
function containerConfigFor(
  type: string,
  field: ChildArrayField,
): ContainerConfig {
  return {
    container: {type, childField: field.name},
    field,
  }
}
