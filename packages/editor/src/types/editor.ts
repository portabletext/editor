 ...
 * @beta
 */
export interface DecorationRenderProps {
  children: ReactNode
  /**
...
export interface Decoration {
   ...
   */
  render: (props: DecorationRenderProps) => ReactElement
}
...
export interface DecorationRegistration {
   ...
   */
  getDecorations(): Array<DecorationPosition>
}
