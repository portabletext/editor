        ...
        expect(formatHTML(getEditorInnerHTML())).toEqual(
          formatHTML(
            [
              ...
              '  <div>',
              '    <span data-slate-node="text" data-pt-path="[_key==&quot;b0&quot;].children[_key==&quot;s0&quot;]" data-child-key="s0" data-child-name="span" data-child-type="span" class="custom-span">',
        ...
        expect(formatHTML(getEditorInnerHTML())).toEqual(
          formatHTML(
            [
              ...
              '    <div>',
              '      <span data-slate-node="text" data-pt-path="[_key==&quot;c0&quot;].content[_key==&quot;b0&quot;].children[_key==&quot;s0&quot;]" data-child-key="s0" data-child-name="span" data-child-type="span" class="scoped-span">',
              '        <span data-slate-leaf="true">',
        ...
        expect(formatHTML(getEditorInnerHTML())).toEqual(
          formatHTML(
            [
              ...
              '  <div data-slate-node="element" data-pt-path="[_key==&quot;c0&quot;].content[_key==&quot;b0&quot;]" class="pt-block pt-text-block pt-text-block-style-normal" data-block-key="b0" data-block-name="block" data-block-type="text" data-style="normal">',
              '    <div>',
              '      <span data-slate-node="text" data-pt-path="[_key==&quot;c0&quot;].content[_key==&quot;b0&quot;].children[_key==&quot;s0&quot;]" data-child-key="s0" data-child-name="span" data-child-type="span" class="fallback-span">',
              '        <span data-slate-leaf="true">',
        ...
        expect(formatHTML(getEditorInnerHTML())).toEqual(
          formatHTML(
            [
              '<div data-slate-node="element" data-pt-path="[_key==&quot;b0&quot;]" class="pt-block pt-text-block pt-text-block-style-normal" data-block-key="b0" data-block-name="block" data-block-type="text" data-style="normal">',
              '  <div>',
              '    <span data-slate-node="text" data-pt-path="[_key==&quot;b0&quot;].children[_key==&quot;s0&quot;]" data-child-key="s0" data-child-name="span" data-child-type="span" class="wins">',
              '      <span data-slate-leaf="true">',
