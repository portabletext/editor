    ...
    await vi.waitFor(() => {
      ...
      expect(normalizeInnerHTML(el!.innerHTML)).toEqual(
        [
          ...
          '<span data-slate-zero-width="n" data-slate-length="0" data-pt-zero-width="n" data-pt-length="0">',
          '\uFEFF<br>',
          '</span>',
          '</span>',
          '</span>',
    ...
    await vi.waitFor(() => {
      ...
      expect(normalizeInnerHTML(el!.innerHTML)).toEqual(
        [
          ...
          '<span data-slate-node="text">',
          '<span data-slate-leaf="true" data-pt-leaf="">',
          '<span data-slate-zero-width="z" data-slate-length="0" data-pt-zero-width="z" data-pt-length="0">\uFEFF</span>',
          '</span>',
          '</span>',
          '</span>',
          ...
          ' data-child-type="span">',
          '<span data-slate-leaf="true" data-pt-leaf="">',
          '<span data-slate-string="true" data-pt-string="true"> world</span>',
          '</span>',
          '</span>',
          '</div>',
          '</div>',
    ...
    await vi.waitFor(() => {
      ...
      expect(normalizeInnerHTML(el!.innerHTML)).toEqual(
        [
          ...
          '<span data-pt-string="true"> USD</span>',
          '</span>',
          '</div>',
          '</td>',
          '</tr>',
    ...
    await vi.waitFor(() => {
      ...
      expect(normalizeInnerHTML(el!.innerHTML)).toEqual(
        [
          ...
          '<span data-pt-string="true">const x = 1</span>',
          '</span>',
          '</div>',
          // line: l1
          '<div data-pt-container=""',
          ...
          '<span data-pt-string="true">const y = 2</span>',
          '</span>',
          '</div>',
          '</code>',
          '</pre>',
