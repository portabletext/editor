...
describe('edge selectors (container awareness)', () => {
  ...
  test('isOverlappingSelection detects overlap inside a container', async () => {
    ...
    // Range strictly before the editor's selection starts (editor: line1[1] → line2[2]).
    // Touching at line1[1] would overlap per the touching = overlap rule, so end at offset 0.
