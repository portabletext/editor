 ...
 * @beta
 */
export interface DecorationWidgetProps {
  children?: ReactNode
  className?: string
  style?: CSSProperties
  title?: string
 ...
 * text: a `Decoration.render`'s `children` must stay outside this
 * component, as a sibling, never nested inside it.
 *
 ...
 * @beta
 */
export function DecorationWidget(props: DecorationWidgetProps) {
