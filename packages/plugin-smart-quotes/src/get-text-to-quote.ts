...
export function getTextToSingleQuote(text: string) {
  return text.match(singleQuotePairRegex)?.at(0)
}

export function getTextToDoubleQuote(text: string) {
  return text.match(doubleQuotePairRegex)?.at(0)
}
